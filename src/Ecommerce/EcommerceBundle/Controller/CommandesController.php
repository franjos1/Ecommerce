...
class CommandesController extends Controller
{
    ...
    public function validationCommandeAction($id)
    {
        ...
        /*$message = \Swift_Message::newInstance()
                ...
                ->setFrom(array('tamdem0199@gmail.com' => "Franjos E-commerce"))
                ->setTo($commande->getUtilisateur()->getEmailCanonical())
                ->setCharset('utf-8')
                ->setContentType('text/html')
                ->setBody($this->renderView('EcommerceBundle:Default:SwiftLayout/validationCommandes.html.twig', array('utilisateur' => $commande->getUtilisateur())));
